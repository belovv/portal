...
import static portal.data.enumdata.Status.ACTIVE;
...
import static portal.data.enumdata.component.MicrosoftComponent.SHAREPOINT_HOSTING;
...
public class AdminCheckVolumeNewSubscription {
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для новой VMware защищенная")
    void checkVolumeNewVMwareProtect() {
        mainPageProvider.adminLink(linkProvider.approveNewSubscription());
        ...
        refresh();
        status.checkStatus(ACTIVE.getValue());
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для новой IX VMware защищенная")
    void checkVolumeNewVMwareIX() {
        mainPageProvider.adminLink(linkProvider.approveNewSubscription());
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для нового Openstack")
    void checkVolumeNewOpenstack() {
        mainPageProvider.adminLink(linkProvider.approveNewSubscription());
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для нового Microsoft")
    void checkVolumeNewMicrosoft() {
        mainPageProvider.adminLink(linkProvider.approveNewSubscription());
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для новой тестовой VMware защищенная")
    void checkVolumeNewTestVMwareProtect() {
        mainPageProvider.adminLink(linkProvider.approveNewTestSubscription());
        ordersSubscriptionsMainPage.clickSubscriptionByName(subscriptionData.vmwareProtectName());
        subscriptionProfilePage.clickOnMenu(REQUESTS.getValue());
        SubscriptionRequestPage subscriptionRequestPage = subscriptionPageFactory.getRequestPage(PROTECT);
        subscriptionRequestPage
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для новой тестовой IX VMware защищенная")
    void checkVolumeNewTestVMwareIX() {
        mainPageProvider.adminLink(linkProvider.approveNewTestSubscription());
        ordersSubscriptionsMainPage.clickSubscriptionByName(subscriptionData.vmwareIXName());
        subscriptionProfilePage.clickOnMenu(REQUESTS.getValue());
        SubscriptionRequestPage subscriptionRequestPage = subscriptionPageFactory.getRequestPage(IX);
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для нового тестового Openstack")
    void checkVolumeNewTestOpenstack() {
        mainPageProvider.adminLink(linkProvider.approveNewTestSubscription());
        ordersSubscriptionsMainPage.clickSubscriptionByName(subscriptionData.openstackName());
        subscriptionProfilePage.clickOnMenu(REQUESTS.getValue());
        SubscriptionRequestPage subscriptionRequestPage = subscriptionPageFactory.getRequestPage(OPENSTACK_CSS);
    ...
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для нового тестового Microsoft")
    void checkVolumeNewTestMicrosoft() {
        mainPageProvider.adminLink(linkProvider.approveNewTestSubscription());
        ordersSubscriptionsMainPage.clickSubscriptionByName(subscriptionData.microsoftName());
        subscriptionProfilePage.clickOnMenu(REQUESTS.getValue());
        SubscriptionRequestPage subscriptionRequestPage = subscriptionPageFactory.getRequestPage(MICROSOFT_CSS);
    ...
    @Disabled("Не закончен, баг на вкладке объемы")
    @TestType.e2e
    @DisplayName("Проверка выставления объемов для нового тестового доступ в Internet")
    void checkVolumeNewTestInternet() {
        mainPageProvider.adminLink(linkProvider.approveNewTestSubscription());
        ordersSubscriptionsMainPage.clickSubscriptionByName(subscriptionData.accessInternetName());
        subscriptionProfilePage.clickOnMenu(REQUESTS.getValue());
        SubscriptionRequestPage subscriptionRequestPage = subscriptionPageFactory.getRequestPage(INTERNET_CSS);
